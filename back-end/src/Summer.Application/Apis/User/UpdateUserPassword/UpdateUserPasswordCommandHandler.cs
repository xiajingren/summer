...
namespace Summer.Application.Apis.User.UpdateUserPassword
{
    public class UpdateUserPasswordCommandHandler : IRequestHandler<UpdateUserPasswordCommand>
    {
        ...
        public UpdateUserPasswordCommandHandler(IUserManager userManager, IReadRepository<Domain.Entities.User> userRepository)
        {
